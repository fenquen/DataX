    ...
    public static class Task extends Reader.Task {
        ...
        public void init() {
            ...
            switch (modeType) {
                ...
                case MultiVersionFixedColumn:
                    ...
                    break;
                default:
                    throw DataXException.build(Hbase11xReaderErrorCode.ILLEGAL_VALUE, "Hbasereader 不支持此类模式:" + modeType);
            }
        }
        ...
        public void prepare() {
            try {
                ...
                throw DataXException.build(Hbase11xReaderErrorCode.PREPAR_READ_ERROR, e);
            }
        }
