...
public final class TableExpandUtil {
    ...
    public static List<String> expandTableConf(DataBaseType dataBaseType, List<String> tableNameList) {
        List<String> parsedTables = new ArrayList<>();
        for (String tableName : tableNameList) {
            List<String> splittedTables = splitTables(dataBaseType, tableName);
