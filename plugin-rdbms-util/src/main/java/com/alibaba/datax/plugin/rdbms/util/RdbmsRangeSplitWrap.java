...
public final class RdbmsRangeSplitWrap {
    ...
    public static List<String> wrapRange(String[] rangeResult,
        ...
        // TODO change to  string builder.append(..)
    ...
    public static String wrapFirstLastPoint(String firstPoint,
                                            String lastPoint,
                                            String columnName,
                                            String quote,
                                            DataBaseType dataBaseType) {
    ...
    public static String wrapFirstLastPoint(Long firstPoint,
                                            Long lastPoint,
                                            String columnName) {
        return wrapFirstLastPoint(
                firstPoint.toString(),
                lastPoint.toString(),
                columnName,
                "",
    ...
    public static String wrapFirstLastPoint(BigInteger firstPoint,
    ...
    private static String quoteConstantValue(String aString, DataBaseType dataBaseType) {
        ...
        if (dataBaseType.equals(DataBaseType.Oracle) || dataBaseType.equals(DataBaseType.SQLServer)) {
