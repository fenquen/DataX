...
public class ColumnCast {
    ...
    public static Date string2Date(StringColumn column) throws ParseException {
        return StringCast.asDate(column);
    }

    public static Date string2Date(StringColumn column, String dateFormat) throws ParseException {
        return StringCast.asDate(column, dateFormat);
    }

    public static byte[] string2Bytes(StringColumn column) throws UnsupportedEncodingException {
    ...
    public static String bytes2String(BytesColumn column) throws UnsupportedEncodingException {
...
class StringCast {
    ...
    static void init(final Configuration configuration) {
        datetimeFormat = configuration.getString("common.column.datetimeFormat", StringCast.datetimeFormat);
        dateFormat = configuration.getString("common.column.dateFormat", StringCast.dateFormat);
        timeFormat = configuration.getString("common.column.timeFormat", StringCast.timeFormat);
        extraFormats = configuration.getList("common.column.extraFormats", Collections.<String>emptyList(), String.class);

        timeZone = configuration.getString("common.column.timeZone", StringCast.timeZone);
        timeZoner = TimeZone.getTimeZone(StringCast.timeZone);

        datetimeFormatter = FastDateFormat.getInstance(StringCast.datetimeFormat, StringCast.timeZoner);
        dateFormatter = FastDateFormat.getInstance(StringCast.dateFormat, StringCast.timeZoner);
        timeFormatter = FastDateFormat.getInstance(StringCast.timeFormat, StringCast.timeZoner);

        encoding = configuration.getString("common.column.encoding", StringCast.encoding);
    }
    ...
    static Date asDate(StringColumn column, String dateFormat) throws ParseException {
        ParseException e;
        try {
    ...
    static byte[] asBytes(StringColumn column)
...
class DateCast {
    ...
    static void init(final Configuration configuration) {
        ...
        timeZone = configuration.getString("common.column.timeZone", DateCast.timeZone);
        timeZoner = TimeZone.getTimeZone(DateCast.timeZone);
    }
        ...
        switch (column.getSubType()) {
            ...
            default:
                throw DataXException
                        .build(CommonErrorCode.CONVERT_NOT_SUPPORT,
...
class BytesCast {
    ...
    static void init(final Configuration configuration) {
        encoding = configuration.getString("common.column.encoding", BytesCast.encoding);
    }
