...
public class DoubleColumn extends Column {
    ...
    public Boolean asBoolean() {
        throw DataXException.build(CommonErrorCode.CONVERT_NOT_SUPPORT, "Double类型无法转为Bool .");
    }

    @Override
    public Date asDate() {
        throw DataXException.build(CommonErrorCode.CONVERT_NOT_SUPPORT, "Double类型无法转为Date类型 .");
    }
    ...
    @Override
    public byte[] asBytes() {
        throw DataXException.build(CommonErrorCode.CONVERT_NOT_SUPPORT, "Double类型无法转为Bytes类型 .");
    }
    ...
    private void validate(final String data) {
        ...
        try {
            ...
            throw DataXException.build(CommonErrorCode.CONVERT_NOT_SUPPORT, String.format("String[%s]无法转为Double类型 .", data));
        }
    }
