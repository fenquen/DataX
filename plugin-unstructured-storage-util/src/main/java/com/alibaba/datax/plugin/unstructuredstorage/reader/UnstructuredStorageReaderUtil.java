...
public class UnstructuredStorageReaderUtil {
    ...
    public static void readFromStream(InputStream inputStream, String context,
        ...
        try {
            ...
            throw DataXException
                    .build(UnstructuredStorageReaderErrorCode.OPEN_FILE_WITH_CHARSET_ERROR,
    ...
    public static void doReadFromStream(BufferedReader reader, String context,
        ...
        try {
            ...
            if (skipHeader) {
                ...
                LOG.info(String.format("Header line %s has been skiped.", line));
            }
            ...
            throw DataXException.build(UnstructuredStorageReaderErrorCode.OPEN_FILE_WITH_CHARSET_ERROR,
                    String.format("不支持的编码格式 : [%s]", encoding), uee);
        } catch (FileNotFoundException fnfe) {
            throw DataXException.build(UnstructuredStorageReaderErrorCode.FILE_NOT_EXISTS,
            ...
            throw DataXException.build(UnstructuredStorageReaderErrorCode.RUNTIME_EXCEPTION,
